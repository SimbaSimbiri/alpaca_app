...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run technical-indicator strategy backtests using historical daily OHLCV data."
    )
    ...
    parser.add_argument("--output-root", default="outputs", help="Folder where charts, data, and PDF report are saved locally.")
